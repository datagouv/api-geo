...
function codesPostauxFictifs() {
  return function (ctx, next) {
    forEach({
      '75000': '75056',
      '13000': '13055',
      '69000': '69123',
    }, function (code, codePostal) {
...
/* Exports */
module.exports = { isIgnoredCommune, init, loadCommunes, loadGeometries, loadCodePostaux, codesPostauxFictifs, loadPopulation, serialize, aggregate, checkCommunes };
